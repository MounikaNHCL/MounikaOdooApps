/** @odoo-module **/
odoo.define('project_c_click_task.mail_fun', function (require) {
'use strict';
import { sampleFunction } from '@mail/model/model_core';
var DataSet = sampleFunction.extend(registerModel, {
       fields: {
        /**
